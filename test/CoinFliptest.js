...
contract("CoinFlip", async function(accounts){
  ...
  it("should deploy properly with added balance", async function(){
    let instance = await CoinFlip.deployed( { from:accounts[5],value: web3.utils.toWei("1", "ether")}) ;
  ...
  it("should take input and return event", async function(){
    ...
    await instance.placeBet("1", {from: accounts[5], value: web3.utils.toWei("1", "ether")});
  ...
  it("should deposit funds", async function(){
    let instance = await CoinFlip.new({from: accounts[5], value: web3.utils.toWei("1", "ether")});
    await truffleAssert.passes(instance.Deposit({from: accounts[5],value: web3.utils.toWei("1", "ether")
    })
  )});
